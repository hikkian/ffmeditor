  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b border-[var(--color-border)]">
        ...
        <h2 className="text-sm font-semibold text-[var(--color-text-primary)]">Controls</h2>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-5">
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-3">
            <div className="w-1 h-3 rounded-full bg-[var(--color-accent)]" />
            <span className="text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wider">Trim</span>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-1.5">
              <div className="w-1 h-3 rounded-full bg-[var(--color-purple)]" />
              <span className="text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wider">Resize</span>
            </div>
          </div>
          {/* Source info badge */}
          {activeFile && activeFile.width > 0 && (
            <div className="mb-3 px-3 py-2 rounded-lg bg-[var(--color-purple-muted)] border border-[var(--color-purple)]/20">
              <div className="flex items-center gap-1.5 mb-1">
                <svg className="w-3 h-3 text-[var(--color-purple)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-[10px] font-medium text-[var(--color-purple)] uppercase tracking-wider">Source</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-xs font-mono text-[var(--color-text-primary)]">{activeFile.width} × {activeFile.height}</span>
                {activeFile.fileSize && (
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-3">
            <div className="w-1 h-3 rounded-full bg-[var(--color-success)]" />
            <span className="text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wider">Output</span>
          </div>
          <div className="space-y-3">
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-3">
            <div className="w-1 h-3 rounded-full bg-[var(--color-warning)]" />
            <span className="text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wider">Quality</span>
          </div>
          <div className="space-y-3">
            <div>
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-3">
            <div className="w-1 h-3 rounded-full bg-[#ec4899]" />
            <span className="text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wider">Effects</span>
          </div>
          <div className="space-y-3">
            {/* Brightness */}
            <div>
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-3">
            <div className="w-1 h-3 rounded-full bg-[var(--color-error)]" />
            <span className="text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wider">Audio</span>
          </div>
        ...
        <button
          ...
          className={`w-full py-2.5 rounded-xl text-sm font-semibold transition-all ${
            isExporting
              ...
              : 'bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-purple)] text-white hover:shadow-lg hover:shadow-[var(--color-accent)]/25 hover:-translate-y-0.5 active:translate-y-0'
          }`}
        >
          {isExporting ? (
